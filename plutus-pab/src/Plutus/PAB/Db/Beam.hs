...
runBeamStoreAction ::
    ...
    -> Eff '[ContractStore (Builtin a), LogMsg (PABMultiAgentMsg (Builtin a)), DelayEffect, IO] b -- -> Eff '[ContractDefinitionStore (Builtin a), ContractStore (Builtin a), DelayEffect, IO] b
