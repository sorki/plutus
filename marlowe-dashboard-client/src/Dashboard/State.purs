...
import Dashboard.Lenses (_card, _cardOpen, _contractFilter, _contracts, _menuOpen, _selectedContract, _selectedContractIndex, _templateState, _walletDataState, _walletDetails)
